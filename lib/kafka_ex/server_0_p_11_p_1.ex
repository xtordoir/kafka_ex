defmodule KafkaEx.Server0P11P1 do
    @moduledoc """
    Implements kafkaEx.Server behaviors for kafka 0.11.1 API.
    """
    use KafkaEx.Server
    ...
    defp first_broker_response(request, state) do
      ...
      def kafka_server_produce(produce_request, state) do
        ...
        response = case broker do
          nil    ->
            Logger.log(:error, "Leader for topic #{produce_request.topic} is not available 0.11.1")
